...
func (*PingMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_a8fbcef7733eddb5, []int{0}
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_a8fbcef7733eddb5) }

var fileDescriptor_api_a8fbcef7733eddb5 = []byte{
